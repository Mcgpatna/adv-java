...
public class HotelAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatch=getServletContext().getRequestDispatcher("/HotelDetail.jsp");
        ...
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("ExoticaTravelsPU2");
            ...
            Query query1 = em.createNativeQuery("SELECT * FROM HOTELS");
        ...
        name=request.getParameter("hnm");
        price=Double.parseDouble(request.getParameter("price"));
        System.out.println(" code ="+code +" name ="+name+ " price ="+price);
        Query query2 = em.createNativeQuery("INSERT INTO hotels VALUES('" + code + "','" + name + "'," + price + ")");
        ...
        {
            System.out.println("Error in adding Hotel details "+e);
        }         
